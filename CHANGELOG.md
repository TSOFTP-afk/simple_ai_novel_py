...
| 版本 | 构建时间 | 文件名 | SHA256 |
| --- | --- | --- | --- |
| 灵枢 v1.2 | 2026-05-13 | `SimpleAINovelApp-灵枢v1.2.exe` | `3FCB5CEB12A174222991DE4AF60B3AC276D301E55E3E2C7EEC298351D40D12D4` |
| 灵枢 v1.1 | 2026-05-11 | `SimpleAINovelApp-灵枢v1.1.exe` | `0F2D5DD450DC75BA22B370CF9711A6DE4C38F1E86A0C9A42F21C416BF1C20262` |

## 灵枢 v1.2 — 工具栏重构 + 视频背景版（2026-05-11）

- **工具栏重构**：导出独立为「导出 ▾」按钮含子菜单（TXT/MD/DOCX），与右键菜单一致
- **AI 设置入口提升**：AI 设置移至顶部「AI ▾」按钮展开的最上方
- **视图配置入口提升**：视图配置移至顶部「视图 ▾」按钮展开的最上方
- **删除项目学习**：移除项目学习对话框及其底层调研池导入功能
- **MP4 视频背景**：支持 .mp4/.avi/.mkv/.webm 等视频格式作为动态底层背景
...
## 灵枢 v1.1 — 人名快键版（2026-05-11）

- **人名快键**：书籍级新增「快键」抽屉 Tab，自定义快捷键（如 `Ctrl+D`）→ 按章节正文光标处插入对应人名
- 支持手动新增、从人物列表选取、删除快键
- 仅在书籍级可见，其他层级自动隐藏
